...
INTRODUCTION
The source, executables, and media in this package were created as a part
...
GAME
The game provides a simple level and some models for the user to examine.
The player can either view the world through third-person view of the main
player or a debug camera that can moved anywhere.
...
[Shift]         Accelerate          Increases the players acceleration while held down with movement key


DEBUG CAMERA CONTROLS
The debug camera supports several duplicate controls for ease of use depending
on user preference. The first scheme uses keyboard arrow keys and the second 
scheme uses the keyboard and mouse.
