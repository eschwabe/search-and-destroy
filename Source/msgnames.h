...
REGISTER_MESSAGE_NAME(MSG_StartFireProjectiles)
REGISTER_MESSAGE_NAME(MSG_StopFireProjectiles)
REGISTER_MESSAGE_NAME(MSG_FireBigProjectile)
REGISTER_MESSAGE_NAME(MSG_Damaged)
REGISTER_MESSAGE_NAME(MSG_PathComputed)
REGISTER_MESSAGE_NAME(MSG_GameStart)
REGISTER_MESSAGE_NAME(MSG_Reset)
REGISTER_MESSAGE_NAME(MSG_DebugMode)
